      ...
      <div className=" heigh100 backgrd" style={ { backgroundImage: 'url(' + BckgrdUrl + ')' } }>
        <div className="row makeBackgroundlight">
          <div className="col-12" style={ { padding: '10px 10px 10px 25px' } }>
            <a href="/signup" className='whitehover' style={ { color: 'white !important' } }>
              <div className='registrieren_botton'>Registrieren
              </div>
            </a>
            <div>
              <p className="keinMitglied" style={ { float: 'right', paddingTop: '23px', fontSize: '16px' } }>noch kein Mitglied?</p>
            </div>
            <Switch>
