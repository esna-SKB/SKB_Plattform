          ...
          <div className="col col-sm-12" style={ { paddingRight: '0', paddingLeft: '0' } }>
            <div className="tab-content col-offset-6 centered" id="tab-content">
              <div className="tab-pane fade show active" id="ubersicht" role="tabpanel" aria-labelledby="ubersicht-tab" style={ { backgroundColor: 'white', border: '1px solid #efefef', padding: '20px' } }>
                ...
                <p>Course name : </p>
                <input type="text" name="name" id="course_name" style={ { borderColor: 'transparent', borderBottomColor: 'black', borderBottomWidth: '1px', width: '100%', marginBottom: '20px' } } />
                <br />
                <p>Course Description : </p>
                <textarea rows="4" cols="50" name="description" id="course_description" style={ { width: '100%' } } />
                <br />
                <div className='row' style={ { paddingBottom: '20px' } }>
                  <div className='col-6'>
                    <p>
                      ...
                      <br/>
                      <br/> Nein
                      <input type="radio" name="kostenpflichtig" value="no" defaultChecked={ isFree } onChange={ this.checkboxHandler } />
                      <br/> Ja
                      <input type="radio" name="kostenpflichtig" value="yes" onChange={ this.checkboxHandler } />
                    </p>
                  </div>
                </div>
