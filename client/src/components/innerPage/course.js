...
class FeedTab extends Component{
    postArticle = () =>{
              ...
              api.createArticle(this.props.course.name, "", this.props.user, text, Date.now).then(res => {
...
class Course extends Component {
  ...
  render() {
    ...
    //user is not an enrolled student neither is he the responsible teacher
    else if(this.state.enrolled === false && this.state.course.teacher != this.props.user.email){
    return (
      <div>
