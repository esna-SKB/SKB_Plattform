      ...
      return (
        ...
        <div className="col-6">
          ...
          <div className="namefield">
            ...
            <input id="lastName" className="input_login lastname" type="text" placeholder="Nachname" name="nachname" value={signUpLastName}  onChange={this.onTextboxChangeSignUpLastName}/>
          </div>
